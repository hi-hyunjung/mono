...
export type OAIMethodPathKeys<TMethod extends OAIMethods> = O.SelectKeys<paths, Record<TMethod, unknown>>;

export type OAIPathParameters<TPath extends OAIPathKeys, TMethod extends OAIMethods> =
  O.Path<paths, [TPath, TMethod, 'parameters', 'path']> extends Record<string, unknown> ?
...
export type OAIRequestBody<TPath extends OAIPathKeys, TMethod extends OAIMethods> = O.Path<
  paths,
  [TPath, TMethod, 'requestBody', 'content', 'application/json']
>;

export type OAIParameters<TPath extends OAIPathKeys, TMethod extends OAIMethods> =
  ...
  : OAIQueryParameters<TPath, TMethod> extends Record<string, unknown> | undefined ? OAIQueryParameters<TPath, TMethod>
  : undefined;
...
export type OAIMutationResponse<TPath extends keyof paths, TMethod extends OAIMethods> = O.Path<
  paths,
